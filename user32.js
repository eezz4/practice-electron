...
module.exports = () => {
  ...
  return {
    getProcessId: (windowHandle) => {
      ...
      if (!ret) throw new Error("getProcessId 1");
    ...
    getTitleByWindowHandle: (windowHandle) => {
      ...
      if (length === null) throw new Error("getTitleByWindowHandle 1");
    ...
    restoreWindow: (windowHandle) => {
      ...
      // win32 showWindow() return value : if previously hidden, value is zero;
